<style>
	...
	#alamat_show_list_back .panel-group .panel .panel-body #create-new_button{
		float:left;
	}
	#alamat_show_list_back .panel-group .panel .panel-body #search_box{
		float:right;
	}
    ...
    <div class="panel-group">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <a id="create-new_button" href="<?php echo base_url()."admin/alamat-sekre/create-new";?>"><button class="btn btn-primary">Buat Baru</button></a>
                <div id="search_box">
                    <form id="myForm" method="post" action="<?php echo base_url()."admin/alamat-sekre";?>" class="col-md-12 col-sm-12 col-xs-12">
                ...
                <table class="table table-striped">
                    ...
                    <tbody><?php
                        for($i=0;$i<sizeof($all_alamat_content);$i++){?>
                            <tr>
                            	<td><?php echo $all_alamat_content[$i]['nama_kota'];?></td>
                                <td>
                                    <table>
                                    	<tr><td>Area : <?php echo $all_alamat_content[$i]['nama_area'];?></td></tr>
                                        <tr><td><?php echo $all_alamat_content[$i]['alamat'];?></td></tr>
                                        <tr><td><?php echo $all_alamat_content[$i]['no_hp'];?></td></tr>
                                  	</table>
                                </td>
                                <td>
                                    <a href="<?php echo base_url()."admin/alamat_sekre/edit/".$all_alamat_content[$i]['id'];?>"><button class="btn btn-primary">Edit</button></a>
                                    <a href="<?php echo base_url()."admin/alamat_sekre/delete/".$all_alamat_content[$i]['id'];?>" onclick="return confirm('Apakah yakin ingin Menghapus data?');"><button class="btn btn-danger">Delete</button></a>
                                </td>
                            </tr><?php
                        }?>
                    </tbody>

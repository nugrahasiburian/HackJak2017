<style>
	...
	#area_edit .cover_image img {
		width:100%;
		height:100%;
	}
	#area_edit .jam.col-md-1{
		width:120px;
	}
	#area_edit .tanggal.col-md-2{
		width:180px;
	}
</style>
    ...
    <div class="panel-group">
        <div class="panel panel-default">
            <div class="panel-heading">
                <span class="my_h2"><div class="glyphicon glyphicon-pushpin"></div><span>&nbsp;<?php if($type_new_or_edit=="create_new"){ echo "Tulis Area Baru";}elseif($type_new_or_edit=="edit"){ echo "Edit Area";}?></span></span>
            </div>
            <div class="panel-body">
                <form action="<?php echo base_url()."admin/area/".$type_new_or_edit."/save";?>" method="post" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class=" col-md-4">
                            <textarea name="nama_area" class="form-control"><?php if($type_new_or_edit=="edit"){echo $selected_content_detail[0]['nama_area'];}?></textarea>
                        </div>
                    </div>

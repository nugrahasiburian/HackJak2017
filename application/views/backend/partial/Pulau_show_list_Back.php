<style>
	...
	#pulau_show_list_back .panel-group .panel .panel-body #create-new_button{
		float:left;
	}
	#pulau_show_list_back .panel-group .panel .panel-body #search_box{
		float:right;
	}
</style>
    ...
    <div class="panel-group">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <a id="create-new_button" href="<?php echo base_url()."admin/pulau/create-new";?>"><button class="btn btn-primary">Buat Baru</button></a>
                <table class="table table-striped">
                    ...
                    <tbody><?php
                        for($i=0;$i<sizeof($all_pulau_content);$i++){?>
                            <tr>
                            	<td><?php echo $all_pulau_content[$i]['urutan'];?></td>
                                <td><?php echo $all_pulau_content[$i]['nama_pulau'];?></td>
                                <td>
                                    <a href="<?php echo base_url()."admin/pulau/edit/".$all_pulau_content[$i]['id'];?>"><button class="btn btn-primary">Edit</button></a>
                                    <a href="<?php echo base_url()."admin/pulau/delete/".$all_pulau_content[$i]['id'];?>" onclick="return confirm('Apakah yakin ingin Menghapus data?');"><button class="btn btn-danger">Delete</button></a>
                                </td>
                            </tr><?php
                        }?>
                    </tbody>
